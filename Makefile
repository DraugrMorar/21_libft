...
#    Updated: 2018/12/13 16:06:53 by dmorar           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = 	libft.a

SRC = 	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_bzero.c ft_isdigit.c\
...
ft_strstr.c ft_strsub.c ft_strtrim.c ft_tolower.c ft_toupper.c ft_isascii.c
...
ft_putstr_fd.o ft_strcat.o ft_strchr.o ft_strcat.o ft_strcmp.o ft_strcpy.o\
...
ft_strstr.o ft_strsub.o ft_strtrim.o ft_tolower.o ft_toupper.o ft_strclr.o

all: $(NAME)

$(NAME):
	gcc -Wall -Wextra -Werror libft.h -c $(SRC)
	ar rc $(NAME) $(OBJ)
	ranlib $(NAME)
